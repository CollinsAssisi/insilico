...
class S_DefaultSynapse : public Synapse {
 public:
  void ode_set(state_type &variables, state_type &dxdt, const double t, unsigned index) {
    ...
    // ODE set
    dxdt[g1_index] = g2;
<<<<<<< HEAD:include/synapse/S_DefaultSynapse.hpp
    dxdt[g2_index] = -((tau1*tau2) * g2 - g1 + gsyn * xt) / (tau1 + tau2);
=======
    dxdt[g2_index] = (gsyn * xt - g1 - (tau1+tau2) * g2) / (tau1*tau2);
>>>>>>> 6b93c2c001747aa72a5621712c5a1d6c5ffb360d:include/insilico/synapse/S_DefaultSynapse.hpp
